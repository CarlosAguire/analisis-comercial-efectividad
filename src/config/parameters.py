...
FTTH_HFC_CAPACITY_TYPES = {
    ...
    "Zonas de trabajo": "string",
    "Aptitud laboral": "string",
    "Zona": "string",
    "Fin": "string",
    "Inicio - Fin": "string",
    "Inicio de SLA": "string",
    "Fin de SLA": "string",
    "Tiempo de viaje": "string",
    "Ventana de entrega": "string",
    "Duración": "string",
    "Departamento": "string",
    "Nodo": "string",
    "Número de cuenta": "string",
    "Estado interno de la OT": "string",
    "Numero de Reincidencias Serivicios": "string",
    "Numero de Reincidencias Calidad": "string",
    "Numero de Reprogramaciones": "string",
    "SLA Suscriptor": "string",
    "SLA Cumplimiento": "string",
    "Estado SLA": "string",
    "Materials Validation Result": "string",
    "Resultados SoftClose": "string",
    "Agent Confirmation": "string",
    "Regional": "string",
    "Prioridad": "string",
    "Nombre Completo.1": "string",
    "Unidad de Gestión": "string",
    "Número de Ticket Fallas Masivas": "string",
    "Código de causa 1 del IIMS": "string",
    "Código de causa 2 del IIMS": "string",
    "Código de causa 3 del IIMS": "string",
    "Fecha de agendamiento": "string",
    "External ID": "string",
    "Dirección campo 1": "string",
    "Intervalos de tiempo": "string",
    "Razón": "string",
    "Persona que Confirma": "string",
    "Lista de Razon": "string",
    "Coordenada X": "string",
    "Coordenada Y": "string",
    "Agenda Inmediata": "string",
    "Fecha de creación de la OT YYYY-MM-DD": "string",
    ...
    "Teléfono": "string",
    "Owner": "string",
    "Propietario RN Validado": "string",
    "Troncal FTTH": "string",
    "Check Reserva RN": "string",
    "Check RN Migrada": "string",
